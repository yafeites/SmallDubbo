...
//   采用的序列化协议
    ...
    static {
        ...
        try {
            ...
            Serializer = properties.getProperty("server.serializer", "Hessian");
            channelPoolSize=Integer.parseInt(properties.getProperty("client.channelPoolSize","10"));
            threadWorkerNumber=Integer.parseInt(properties.getProperty("client.threadWorkers"),10);
        } catch (Throwable t) {
