package framework.call;

import framework.context.ResponseReceiverHolder;
import io.netty.channel.Channel;
import io.netty.channel.ChannelFuture;
import framework.message.RequestMessage;
...
public class InvokerCallableService implements Callable<ResponseMessage> {
    private static final Logger LOGGER = LoggerFactory.getLogger( InvokerCallableService.class);
    ...
    public InvokerCallableService(InetSocketAddress inetSocketAddress, RequestMessage request) {
